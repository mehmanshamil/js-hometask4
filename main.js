...
// function countrySearch(id) {
//     let idnumber = result.find(item => item.id === id);
//     let country =idnumber.shipAddress.country;
//     console.log(country);
// }
// countrySearch(11070)
...
//     let region = result.filter(item => item.shipAddress.country === country );

//         console.log(region);
// }
// countrySearch("Germany")

// eger isdeyirikse sadeca 1 dene ilk cavab serti odeyen olke olsun onda find metodundan isdifade ederdik:

// function countrySearch(country) {

//     let region = result.find(item => item.shipAddress.country === country );
...
// function search(id){
//     let idnumber = result.find(item => item.id === id);
//     let shipName = idnumber.shipName;
//     let country = idnumber.shipAddress.country;
//     let city = idnumber.shipAddress.city;
//     console.log(`SHIPNAME: ${shipName}; COUNTRY: ${country}; CITY: ${city};`);
// }
// search(11071)
...
// function search(id) {
//     let idnumber = result.find(item => item.id === id);
//     let resultType = idnumber.details.length;
//     console.log("Neçə növdə satış edildiyi : " + resultType);
//     //umumi satis sayi ise asagidaki kimidir:
//     let totalResult = idnumber.details;
//     let sum = 0;
//     totalResult.forEach(function (item) {
//         sum += item.quantity;
//     });
//     console.log("Umumi satis edilen miqdar : " + sum);
// }
// search(11075)
...
//     let idnumber = result.find(item => item.id === id);
//     let detail = idnumber.details;
//     let sum = 0;
//     detail.forEach(item => {
//         sum += (1 - item.discount) * item.quantity * item.unitPrice;
//     })

//     console.log(`Toplam qazanc : ${sum}`);
// }
// totalPrice(11075)